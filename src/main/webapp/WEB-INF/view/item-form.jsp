              ...
              <div class="form-group">
                <div class="form-row">
                  <div class="col-md-6">
                    ...
                    <form:input path="itemName" class="form-control" id="itemName" type="text" placeholder="Enter item name" />
                  </div>
                  <div class="col-md-6">
              ...
              <div class="form-group">
                <div class="form-row">
                  <div class="col-md-6">
                    ...
                    <form:input path="price" class="form-control" id="price" type="text" placeholder="Enter price" />
                  </div>
                  <div class="col-md-6">
                    <label for="quantity">Quantity</label>
                    <form:input path="quantity" class="form-control" id="quantity" type="text" placeholder="Enter quantity" />
                  </div>
                </div>
              </div>
              <div class="form-group">
                <div class="form-row">
                  <div class="col-md-4">
                    ...
                    <form:input path="discount" class="form-control" id="discount" type="text" placeholder="Enter discount" />
                  </div>
                  <div class="col-md-4">
                    <label for="categoryID">Category ID</label>
                     <form:input path="categoryID" class="form-control" id="categoryID" type="text" placeholder="Enter category id" />
                  </div>
                </div>
              </div>
              <input type="submit" value="Apply & Save" class="btn text-white bg-success btn-block" />
            </form:form>
            <a href="${pageContext.request.contextPath}/item/list" class="btn btn-secondary btn-block vert-offset-top-1">Back to List</a>
          </div>
        </div>
      </div>
    </div>
