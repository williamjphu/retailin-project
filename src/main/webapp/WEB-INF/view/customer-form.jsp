      ...
      <div class="card card-register mx-auto mt-5">
        <div class="card-header">Customer Information Form</div>
          <div class="card-body">
             ...
             <%--  <form:hidden path="customer" /> --%>
              <div class="form-group">
                <div class="form-row">
                  <div class="col-md-6">
                    ...
                    <form:input path="phoneNumber" class="form-control" id="phoneNumber" type="text" placeholder="Enter your phone number" />
                  </div>
                  <div class="col-md-6">
              ...
              <div class="form-group">
                <div class="form-row">
                    ...
                    <form:input path="zipCode" class="form-control" id="zipCode" type="text" placeholder="Enter zipcode" />
                  </div>
                </div>
              </div>
              <div class="form-group">
            ...
            <a href="${pageContext.request.contextPath}/customer/list" class="btn btn-secondary btn-block vert-offset-top-1">Back to List</a>
          </div>
        </div>
      </div>
    </div>
